                ...
                switch (Path.GetExtension(dlg.FileName))
                {
                    ...
                    case ".json":
                        ...
                        using (var r = new StreamReader(fs))
                        {
                            ...
                            obj = (Object[])jf.Deserialize(r, typeof(Object[]));
                            points = new Point[5];
                            ...
                            for (int i = 0; i < 5; i++)
                            {
                                ...
                                if (str.Length >= 36)
                                {
                                    points[i] = new Point3D(int.Parse(str.Substring(21, 1)), int.Parse(str.Substring(32, 1)), int.Parse(str.Substring(10, 1)));
                                }
                                else
                                {
                                    points[i] = new Point(int.Parse(str.Substring(10, 1)), int.Parse(str.Substring(21, 1)));
                                }
                            }
                        }
                        break;
